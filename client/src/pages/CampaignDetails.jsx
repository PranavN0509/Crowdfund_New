...
const CampaignDetails = () => {
  ...
  const { donate, getDonations, contract, address } = 0;
  ...
  const handleCampaignProgress = () => {
    navigate(`/campaign-details/campaign-progress/${state.title}`, { state: state });
  }
    ...
    <div>
      ...
      <div className="w-full flex md:flex-row flex-col mt-10 gap-[30px]">
        ...
        <div className="flex md:w-[150px] w-full flex-wrap justify-between gap-[30px]">
          ...
          <CountBox title="Total Backers" value="60" />
        </div>
      </div>
      <div className="mt-[60px] flex lg:flex-row flex-col gap-2">
        <h4 className="font-semibold text-[22px] text-black dark:text-white uppercase">{state.title}</h4>
      </div>
