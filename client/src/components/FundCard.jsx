...
const FundCard = ({ owner, title, description, target, deadline, amountCollected, image, handleClick }) => {
  ...
  return (
    <div className="border-[0.1px] border-[#c3ffb4] sm:w-[288px] w-full rounded-[10px] bg-[#fff] dark:bg-[#1c1c24] cursor-pointer" onClick={handleClick}>
      <img src={image} alt="campaign image" className="w-full h-[158px] object-cover rounded-[10px]" />
